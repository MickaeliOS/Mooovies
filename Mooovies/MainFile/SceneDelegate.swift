...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // Main Scene
        let welcomeVC = MovieListBuilder.build()
        welcomeVC.tabBarItem = UITabBarItem(title: "Movies", image: UIImage(systemName: "movieclapper"), tag: 0)
        ...
        tabBarVC.viewControllers = [welcomeNVC, creditsVC]
